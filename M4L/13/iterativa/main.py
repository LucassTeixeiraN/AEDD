...
def main():
    ...
    while True:
        ...
        if option == "1":
            ...
            k = int("Insira a posição do novo elemento: ")
            num = int("Insira o elemento: ")
            newList.insertElement(num, k)
        elif option == '4':
            pos1 = int("Insira a posição do primeiro elemento a ser trocado")
            pos2 = int("Insira a posição do segundo elemento a ser trocado")
